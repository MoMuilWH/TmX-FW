...
# Decompiled from: Python 3.7.1 (default, Oct 21 2018, 18:43:10) 
# [Clang 7.0.2 (https://android.googlesource.com/toolchain/clang 003100370607242d
# Embedded file name: /data/data/com.termux/files/home/TMX.py
# Compiled at: 2018-11-06 18:41:47
import os
white = '\x1b[1;37m'
normal = '\x1b[0;00m'
red = '\x1b[1;31m'
...
print '\t 16-Programing'
print '         17-Social Engineer'
print '   \x1b[91m      18-Install && UpdatE'
print '         19-My WebSit'
print '         0-ExiT'
im = raw_input('TMX >>!')
if im == '1':
...
if mang == '1':
 import os
 os.system('termux-open-url https://play.google.com/store/apps/details?id=com.ssinnovations.fakeemail')
elif mang == '2':
 import os
 os.system('termux-open-url http://smikta.net/')
elif mang == '3':
 import os
 os.system('termux-open-url http://www.afreesms.com/freesms/')
elif mang == '4':
 import os
 os.system('termux-open-url https://temp-mail.org/ar/')
if im == '19':
 import os
 print ('sooooooon')
...
if im == '9':
    import os
    name0 = raw_input('Enter Name :')
    os.system('sleep 2')
    os.system('cd ../usr/etc && rm bash.bashrc')
    ft = open('bash.bashrc', 'w')
    ft.write('figlet ' + name0)
    os.system('mv bash.bashrc ../usr/etc')
else:
    import os
    print ('Err ):')
    os.system('sleep 2')
